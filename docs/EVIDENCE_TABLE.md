...
| **Riemann** | GUE mode | 0.6267 | 1/φ = 0.618 | **1.4%** | STRONG |
| | Min spacing | ~0.382 | 1/φ² = 0.382 | **< 1%** | STRONG |
| | Spacing excess | 7.3× at 1/φ | Peak | Yes | STRONG |
...
| Riemann | GUE mode | 1.4% |
| Riemann | Min spacing | < 1% |
...
| 1/φ = 0.618 | (√5-1)/2 | Riemann GUE, BSD decay, Hodge |
| **1/(2φ) = 0.309** | **δ₀** | **NS depletion, P vs NP base radius** |
| 1/φ² = 0.382 | (3-√5)/2 | Riemann min spacing |
...
|--------|-------|
| Total findings | 17 |
| **Strong (< 2% or exact)** | **10 (59%)** |
| Revised (dynamic φ) | 2 (12%) |
| Moderate (2-6%) | 2 (12%) |
| Suggestive/Weak (>6%) | 3 (18%) |
...
║   • Riemann: Zeros (discrete) → GUE statistics (continuous)           ║
...
- **Riemann**: LMFDB zero database, GUE random matrix theory
